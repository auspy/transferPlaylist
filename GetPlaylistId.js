...
var typeData = {
  spotify: {
    ...
    steps: [/*#__PURE__*/React.createElement("div", {
      key: Math.random()
    }, /*#__PURE__*/React.createElement("h2", null, "From browser"), /*#__PURE__*/React.createElement("div", null, "1. open ope.spotify.com on any browser"), /*#__PURE__*/React.createElement("div", null, "2. copy url from search bar")), /*#__PURE__*/React.createElement("div", {
      key: Math.random()
    }, /*#__PURE__*/React.createElement("h2", null, "From web app"), /*#__PURE__*/React.createElement("div", null, "1. Open playlist section "), /*#__PURE__*/React.createElement("div", null, "2. Right click on playlist "), /*#__PURE__*/React.createElement("div", null, "3. click on share playlist"), /*#__PURE__*/React.createElement("div", null, "4. copy share link"))],
    url: "spotifyToYt"
  },
  youtube: {
    color: "var(--youtube)",
...
var TypeButtons = function TypeButtons(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "frc w100"
  }, types === null || types === void 0 ? void 0 : types.map(function (type) {
    var _typeData$from;
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        borderWidth: 0,
        borderBottomWidth: 1,
        borderBottomColor: type.split("to")[0].trim() == from && ((_typeData$from = typeData[from]) === null || _typeData$from === void 0 ? void 0 : _typeData$from.color),
        padding: "11px 0",
        color: type.split("to")[0].trim() == from ? "var(--impText)" : "var(--lightText)"
      }
    }, type);
...
var TransferIcons = function TransferIcons(_ref2) {
  ...
  }, (_typeData$from2 = typeData[from]) === null || _typeData$from2 === void 0 ? void 0 : _typeData$from2.icon, /*#__PURE__*/React.createElement("div", {
    className: "mh15"
  }, /*#__PURE__*/React.createElement(IconRightArrow, null)), (_typeData$to = typeData[to]) === null || _typeData$to === void 0 ? void 0 : _typeData$to.icon);
};
...
var ChangeGetPlaylistFromBtn = function ChangeGetPlaylistFromBtn(_ref4) {
  var _ref4$stepsOf = _ref4.stepsOf,
    ...
    setStepsOf = _ref4$setStepsOf === void 0 ? function () {} : _ref4$setStepsOf;
  ...
  }, typeData && Object.keys(typeData).map(function (type) {
...
var HowToGetPlaylistId = function HowToGetPlaylistId(_ref5) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: ""
  }, /*#__PURE__*/React.createElement("h1", null, "How to get playlist url?"), /*#__PURE__*/React.createElement(ChangeGetPlaylistFromBtn, {
    stepsOf: stepsOf,
    setStepsOf: setStepsOf
  }), /*#__PURE__*/React.createElement("div", {
    id: "steps"
  }, (_typeData$stepsOf = typeData[stepsOf]) === null || _typeData$stepsOf === void 0 ? void 0 : (_typeData$stepsOf$ste = _typeData$stepsOf.steps) === null || _typeData$stepsOf$ste === void 0 ? void 0 : _typeData$stepsOf$ste.map(function (step) {
    return step;
  })));
};
...
var GetPlaylistId = function GetPlaylistId(props) {
  ...
  var getPlaylistId = function getPlaylistId(url) {
    var urlParts = (url === null || url === void 0 ? void 0 : url.split("/").filter(function (item) {
    ...
    if (from == "youtube") {
      ...
      if (urlParts.length === 2) {
        var _urlParts$;
        if (urlParts[0] === "www.youtube.com" && (_urlParts$ = urlParts[1]) !== null && _urlParts$ !== void 0 && _urlParts$.includes("list=")) {
      ...
      if (urlParts.length === 3) {
        var _urlParts$2;
        if (urlParts[0] === "open.spotify.com" && urlParts[1] === "playlist" && ((_urlParts$2 = urlParts[2]) === null || _urlParts$2 === void 0 ? void 0 : _urlParts$2.length) > 0) {
  ...
  console.log(from, "to", to, (_typeData$from4 = typeData[from]) === null || _typeData$from4 === void 0 ? void 0 : _typeData$from4.url);
  ...
  }, "Enter or paste ".concat(from, " playlist url")), /*#__PURE__*/React.createElement("div", {
    className: "regu10 lightColor mb5"
  }, "(Eg: ".concat((_typeData$from5 = typeData[from]) === null || _typeData$from5 === void 0 ? void 0 : _typeData$from5.eg, ")"))), /*#__PURE__*/React.createElement("input", {
    type: "text",
    className: "inputBox mb10",
    maxLength: 200,
    style: {
      height: 46,
      borderColor: !inputUrl ? "var(--lightBg)" : gotoUrl == "#" ? "var(--red)" : "var(--green)"
    },
    value: inputUrl,
    onChange: function onChange(e) {
...
root.render( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GetPlaylistId, home.dataset)));